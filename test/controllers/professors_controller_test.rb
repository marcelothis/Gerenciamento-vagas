...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { bairro: @professor.bairro, celular: @professor.celular, cep: @professor.cep, cidade: @professor.cidade, email: @professor.email, estado: @professor.estado, matricula: @professor.matricula, nome: @professor.nome, numero: @professor.numero, rua: @professor.rua, senha: @professor.senha, telefone: @professor.telefone }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { bairro: @professor.bairro, celular: @professor.celular, cep: @professor.cep, cidade: @professor.cidade, email: @professor.email, estado: @professor.estado, matricula: @professor.matricula, nome: @professor.nome, numero: @professor.numero, rua: @professor.rua, senha: @professor.senha, telefone: @professor.telefone }
    assert_redirected_to professor_path(assigns(:professor))
  end
